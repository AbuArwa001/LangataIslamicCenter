...
export default function MapSection() {
  return (
    <motion.section 
      ...
      className="w-full h-[500px] relative grayscale hover:grayscale-0 transition-all duration-700"
    >
      <iframe
      ...
      <div className="absolute top-10 left-10 bg-white p-4 shadow-2xl rounded-sm border-l-4 border-emerald-600 hidden md:block">
        ...
        <a href="https://maps.app.goo.gl/..." target="_blank" className="text-blue-500 text-[10px] hover:underline uppercase font-bold mt-2 block">View on Google Maps</a>
      </div>
    </motion.section>
  );
}