      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col items-start gap-6">
          ...
          <p className="text-sm leading-relaxed text-gray-400 max-w-xs">
            Dedicated to serving our community with compassion and integrity.
            Join us in our mission to uplift lives.
          </p>
        </div>

        {/* Column 2: Quick Links */}
        <div>
          <h4 className="text-white font-bold mb-6 uppercase text-xs tracking-[0.2em] relative inline-block after:content-[''] after:absolute after:-bottom-2 after:left-0 after:w-8 after:h-0.5 after:bg-emerald-600">
            Quick Links
          </h4>
          <ul className="text-sm space-y-3">
            <li>
              <Link
                href="/about"
                className="hover:text-emerald-500 transition-colors duration-300 flex items-center gap-2"
              >
                About Us
              </Link>
            </li>
        ...
        <div>
          ...
          <ul className="text-sm space-y-4">
            ...
            <li className="flex items-center gap-3">
              ...
              <a
                href="mailto:info@langataislamiccenter.org"
                className="hover:text-white transition-colors"
              >
                info@langataislamiccenter.org
              </a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <Link
              href="#"
              className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-emerald-600 hover:text-white transition-all duration-300 group"
            >
