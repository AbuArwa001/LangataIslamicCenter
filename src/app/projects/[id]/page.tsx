...
export default async function SingleProjectPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const progress = project.goal_amount ? (project.current_amount / project.goal_amount) * 100 : 0;
        ...
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <div className="container mx-auto px-4 py-12 md:py-20">
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-24 bg-white border border-gray-100 rounded-2xl shadow-xl p-8 space-y-8">
                            <div className="space-y-4">
                                <h3 className="text-2xl font-bold text-[#3d2616] font-serif">Support this Project</h3>
                                    ...
                                    <>
                                        ...
                                        <div className="flex justify-between items-end">
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-primary">KES {project.current_amount?.toLocaleString()}</p>
                                            </div>
                                            <div className="text-right">
                                                <p className="text-sm text-muted-foreground font-medium">Goal</p>
                                                <p className="text-lg font-semibold text-[#3d2616]">KES {project.goal_amount.toLocaleString()}</p>
                                            </div>
                                        </div>
                                    </>
                                )}
                            ...
                            <div className="bg-orange-50 rounded-xl p-4 text-sm text-[#5c4033]">
                                ...
                                <p>Your contribution directly supports the completion of this project and benefits the entire community.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-8 pt-12 border-t mt-12">
                    <h3 className="text-3xl font-bold text-center text-[#3d2616] font-serif">Project Gallery</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {["/about_1.jpg", "/about_2.jpg", "/about_3.jpg"].map((img, index) => (
