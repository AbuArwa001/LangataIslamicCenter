                ...
                <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100">
                            <h2 className="text-3xl font-bold text-[#441A05] font-serif mb-8">Make a Donation</h2>
                            <DonationForm />
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        ...
                        <div className="bg-[#441A05] text-white rounded-3xl p-8 shadow-xl">
                            <h3 className="text-2xl font-bold font-serif mb-4">Why Donate?</h3>
                            <p className="text-white/90 leading-relaxed mb-6">
                                Every contribution, no matter how small, makes a significant impact. Your Sadaqah Jariyah helps build a legacy of faith and community support.
                            </p>
                        ...
                        <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
                            <h3 className="text-2xl font-bold text-[#441A05] font-serif mb-6">Other Ways to Give</h3>

                            <div className="space-y-6">
                                <div>
                                    <h4 className="font-bold text-lg text-[#3d2616] mb-2">Bank Transfer</h4>
                                ...
                                <div>
                                    <h4 className="font-bold text-lg text-[#3d2616] mb-2">In-Kind Donations</h4>
                                    <p className="text-[#5c4033] text-sm mb-3">
                                        We accept food, clothes, and other items for our community outreach programs.
                                    </p>
