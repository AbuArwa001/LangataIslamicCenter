...
export const metadata: Metadata = {
  ...
  keywords: "Islamic Center, Mosque, Langata, Nairobi, Kenya, Prayers, Madrasa, Community Services",
  authors: [{ name: "Langata Islamic Center", url: "https://langataislamiccenter.org" }],
