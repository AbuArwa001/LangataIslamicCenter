        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative h-[400px] flex items-center justify-center overflow-hidden">
                 ...
                 <div className="relative z-10 text-center">
                    <h1 className="text-6xl md:text-7xl font-serif text-[#eebb75] tracking-wide drop-shadow-lg">About Us</h1>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-20 max-w-7xl">
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="space-y-8">
                         <h2 className="text-5xl font-serif text-[#1e293b] mb-8">About Us</h2>
                         
                         <div className="space-y-6 text-[#475569] leading-relaxed text-[15px] font-light">
                            <div>
                                <h3 className="text-sm font-bold text-[#334155] uppercase tracking-wider mb-2">History of Langata Islamic Welfare Organisation (LIWO)</h3>
                                <h4 className="text-sm font-bold text-[#334155] uppercase tracking-wider mb-4">How it all started :</h4>
                                <p>
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-[#334155] uppercase tracking-wider mb-2">Establishing a Madrasa :</h4>
                                <p>
                             ...
                             <div>
                                <h4 className="text-sm font-bold text-[#334155] uppercase tracking-wider mb-2">Formation of LIWO :</h4>
                                <p>
                                    It was realized that relying on hosting the Madrasa in the garages of a Government owned Estate was not sustainable. The occupiers of those garages who were public servants could be transferred anytime and the new occupiers might not be as cooperative.
                                </p>
                                <p className="mt-4">
                                    To this end, Langata Islamic Welfare Organisation (LIWO) was established with the cardinal purpose of seeking a more secure place to host the Madrasa as well as dealing with all matters pertaining to Islam. Membership comprised both the old and young. Although the application for registration was lodged immediately, LIWO was eventually issued with the Certificate on 11th August 2009 after several of the interim officials underwent thorough vetting and interrogation by the Government security agencies.
                                </p>
                                <p className="mt-4">
                                    Prior to and after the registration, meetings were being held literally every weekend in the Madrasa to plot how to achieve the intended goals. Attendance was always house full, indicating how eager the members were in getting a solution.
                                </p>
                             </div>
                         </div>

                         <button className="bg-[#2ca082] hover:bg-[#238a6f] text-white px-8 py-3 rounded-full font-medium transition-colors shadow-lg hover:shadow-xl mt-4">
                             Read More
                         </button>
                    </div>
                    ...
                    <div className="relative h-full min-h-[600px] w-full bg-slate-100 rounded-lg overflow-hidden shadow-2xl">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center text-slate-400 bg-slate-200">
                             <img src="/building-render-placeholder.jpg" alt="Future Islamic Center" className="w-full h-full object-cover" />
                        </div>
                    </div>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center py-12">
                     <div className="relative h-[400px] w-full bg-slate-100 rounded-sm overflow-hidden">
                        <div className="absolute inset-0 flex items-center justify-center text-slate-400 bg-slate-200">
                             ...
                             <img src="/mission-placeholder.jpg" alt="Mission Aerial View" className="w-full h-full object-cover" />
                        </div>
                    </div>
                    <div className="space-y-6">
                        <h2 className="text-5xl font-serif text-[#0f172a] mb-4">Our Mission</h2>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center py-12">
                    <div className="space-y-6 lg:order-1 order-2">
                        <h2 className="text-5xl font-serif text-[#0f172a] mb-4">Vision Statement</h2>
                         <p className="text-[#334155] text-lg leading-relaxed max-w-md">
                    ...
                    <div className="relative h-[500px] w-full bg-slate-100 rounded-sm overflow-hidden lg:order-2 order-1">
                        <div className="absolute inset-0 flex items-center justify-center text-slate-400 bg-slate-200">
                             ...
                             <img src="/vision-placeholder.jpg" alt="One of our vision renders" className="w-full h-full object-cover" />
                        </div>
                    </div>
                </div>
                ...
                <div className="pt-12">
                    ...
                    <div className="space-y-16">
                        {/* Chairman Card */}
                        <div className="max-w-3xl mx-auto bg-white rounded-sm overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                            <div className="bg-slate-300 h-80 relative overflow-hidden">
                                 {/* Wave Pattern SVG */}
                                <div className="absolute inset-0 opacity-30">
                                   <svg viewBox="0 0 1440 320" className="absolute bottom-0 w-full h-auto text-white fill-current">
                            ...
                            <div className="p-10 text-center">
                                <h3 className="text-3xl font-serif text-slate-900 mb-2">Ibrahim Said</h3>
                                <p className="text-slate-600 mb-6 font-light">A Renowned Islamic Scholar With 20+ Years Of Community Leadership Experience.</p>
                            ...
                            {[
                                ...
                                <div key={index} className="bg-white rounded-sm overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
                                     <div className="bg-slate-300 h-64 relative overflow-hidden">
                                         {/* Wave Pattern SVG */}
                                        <div className="absolute inset-0 opacity-30">
                                            <svg viewBox="0 0 1440 320" className="absolute bottom-0 w-full h-auto text-white fill-current transform scale-150 origin-bottom">
                                    ...
                                    <div className="p-8 text-center bg-[#f9fafb]">
                                        <h3 className="text-xl font-serif text-slate-900 mb-4">{member.name}</h3>
