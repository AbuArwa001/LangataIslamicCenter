                ...
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {loading ? (
                            ...
                            <tr>
                                <td colSpan={5} className="px-6 py-4 text-center text-sm text-gray-500">No donations found</td>
                            </tr>
                        ) : (
                            donations.map((donation) => (
                                <tr key={donation.id}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">KES {donation.amount}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 capitalize">{donation.payment_method}</td>
